...
function Landing({ onSignIn }) {
  return <div className="landing">
    ...
    <section className="features"><div className="section-intro"><span className="eyebrow">FROM REGISTRATION TO ENTRY</span><h2>How it works</h2><p>One clear workflow for collecting payments, catching risk, and welcoming the right people at the gate.</p></div><div className="f-grid">
